window.CONFIG = {
  macros: [
    ...
    // Music
    {
      ...
      name: 'lofi',
      icon: 'lofi',
      url: 'https://app.lofi.co/',
      normalisedURL: 'app.lofi.co',
      triggers: [
        'lofi',
        'lo'
      ],
    ...
    // https://getcssscan.com/css-box-shadow-examples/
    {
      ...
      normalisedURL: 'getcssscan.com/css-box-shadow-examples/',
      triggers: [
        'getcssscan',
        'box-shadow',
    ...
    // css Dinners
    {
      ...
      normalisedURL: 'flukeout.github.io/',
      triggers: [
        'flukeout',
      ],
      key: 'KeyF',
    ...
    // react
    {
      ...
      normalisedURL: 'react-hook-form.com',
      commands: {
        go: {
          template: '{@}/r/{$}',
